...
```
docker pull maven:4.0.0-rc-5-eclipse-temurin-25-alpine
docker run -it --rm --name my-maven-project -v "$(pwd)":/build -w /build maven:4.0.0-rc-5-eclipse-temurin-25-alpine mvn package
```
