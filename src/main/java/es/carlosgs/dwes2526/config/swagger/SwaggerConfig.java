package es.carlosgs.dwes2526.config.swagger;
...
class SwaggerConfig {
  ...
  OpenAPI apiInfo() {
    return new OpenAPI()
        .info(
            new Info()
                .title("API REST Gestión de Tarjetas Spring Boot DAW 2025/2026")
                .version("1.0.0")
  ...
  GroupedOpenApi httpApi() {
    return GroupedOpenApi.builder()
        ...
        .pathsToMatch("/api/" + apiVersion + "/tarjetas/**") //Solo tarjetas
        .displayName("API Gestión de Tarjetas Spring Boot DAW 2025/2026")
        .build();
  }
}
